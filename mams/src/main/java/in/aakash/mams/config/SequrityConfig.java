package in.aakash.mams.config;


import in.aakash.mams.filter.JwtRequestFilter;
...
public class SequrityConfig {
    ...
    private UrlBasedCorsConfigurationSource corsConfigurationSource(){
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173","https://mams-front-end.vercel.app"));
